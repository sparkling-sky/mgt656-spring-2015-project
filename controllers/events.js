...
function saveEvent(request, response){
  ...
  isRangedInt(request.body.year, 

'year',allowedDateInfo.years[0],allowedDateInfo.years[allowedDateInfo.years.length], 

contextData.errors);

  isRangedInt(request.body.month, 'month',0,11, contextData.errors);

  isRangedInt(request.body.day, 

'day',allowedDateInfo.days[0],allowedDateInfo.years[allowedDateInfo.days.length], 

contextData.errors);

  isRangedInt(request.body.hour, 

'hour',allowedDateInfo.hours[0],allowedDateInfo.years[allowedDateInfo.hours.length], 

contextData.errors);

  isRangedInt(request.body.minute, 

'minute',allowedDateInfo.minutes[0],allowedDateInfo.years[allowedDateInfo.minutes.length], 
